CREATE DATABASE  IF NOT EXISTS `ynahDB` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `ynahDB`;
...
INSERT INTO `customer` (`employee_id`, `first_name`, `last_name`, `job_title`, `hire_date`, `salary`) VALUES
